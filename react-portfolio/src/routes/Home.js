...
import Footer from '../components/Footer'; // imports the Footer component from the Footer.js file in the components folder and assigns it to the variable Footer
